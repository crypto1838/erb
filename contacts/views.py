...
def contact(request):
    if request.method == "POST":
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, "You have already made an inquery for thi listing")
        ...
        messages.success(request, "Your request has been sumbitted, a realtor will get back to you soon")
        return redirect('listings:listing',listing_id=listing_id)
